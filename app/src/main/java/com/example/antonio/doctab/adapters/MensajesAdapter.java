...
public class MensajesAdapter extends RecyclerView.Adapter<MensajesAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView){
            super(itemView);
            txtRemitente = (TextView) itemView.findViewById(R.id.item_mensajes_remitente);
            /**txtDestinatario = itemView.findViewById(R.id.);*/
            txtAsunto = (TextView) itemView.findViewById(R.id.item_mensajes_asunto);
            txtContenido = (TextView) itemView.findViewById(R.id.item_mensajes_contenido);
