...
public class RegistroPacientesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mainFragment.replace(R.id.fragment_registro_paciente_container, new FormularioPacientesFragment(), Constants.FORMULARIO_PACIENTES_FRAGMENT);
        mainFragment.replace(R.id.fragment_acciones_paciente_container, new AccionesPacientesFragment(), Constants.FORMULARIO_ACCIONES_PACIENTES_FRAGMENT);
