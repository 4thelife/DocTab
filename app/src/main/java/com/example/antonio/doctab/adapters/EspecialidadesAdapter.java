...
public class EspecialidadesAdapter extends RecyclerView.Adapter<EspecialidadesAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            txtEspecialidad = (TextView) itemView.findViewById(R.id.item_especialidades_nombre);
            txtSubespecialidad = (TextView) itemView.findViewById(R.id.item_especialidades_subespecialidad_nombre);
            txtUniverisdad = (TextView) itemView.findViewById(R.id.item_especialidades_universidad);
            txtAnoEgreso= (TextView) itemView.findViewById(R.id.item_especialidades_ano_egreso);
